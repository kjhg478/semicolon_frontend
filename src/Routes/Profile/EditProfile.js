      ...
      {(close) => {
        ...
        return (
          <WhiteBox>
            ...
            <Inputs>
              {userInfo.username}
              <Text style={{ marginTop: 30 }}>닉네임 : </Text>
              <TextInput {...username} placeholder={"닉네임"} />
              <Text>이름 : </Text>
              <TextInput {...firstName} placeholder={"이름"} />
              <Text>성 : </Text>
              <TextInput {...lastName} placeholder={"성"} />
              <Text>소개: </Text>
              <TextInput {...bio} placeholder={"상태메세지"} />
            </Inputs>
            <Buttons>
